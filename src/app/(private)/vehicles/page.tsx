...
import TableToolbar from "~/app/(private)/vehicles/_components/table_toolbar";
import TableFooter from "~/app/(private)/vehicles/_components/table_footer";
import { tableColumns } from "~/app/(private)/vehicles/_components/table_columns";
